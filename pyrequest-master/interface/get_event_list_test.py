...
class GetEventListTest(unittest.TestCase):
    ...
    def test_get_event_list01_eid_error(self):
        """ eid=901 查询结果为空 """
    ...
    def test_get_event_list02_eid_success(self):
        """ 根据 eid 查询结果成功 """
    ...
    def test_get_event_list03_nam_result_null(self):
        """ 关键字‘abc’查询 """
    ...
    def test_get_event_list04_name_find(self):
        """ 关键字‘发布会’模糊查询 """
